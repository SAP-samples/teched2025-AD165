...
- [Exercise 2 - Add a simple UI integration card for usage in your workspace](exercises/ex2/)
    ...
    - [Exercise 2.3 - Make the new card available to all Work Zone users](exercises/ex2#make-card-available)
    - [Exercise 2.4 - Add the new card to the workspace's Welcome page](exercises/ex2#add-card-to-page)
